...
**Extension of enactivism:** Froese (2026) argues that LLMs can become non-biological sense-makers; this study further demonstrates that the products of sense-making can persist independently after the interaction partner goes offline, extending beyond the explanatory boundaries of the standard enactivist framework (Varela, Thompson & Rosch, 1991).
