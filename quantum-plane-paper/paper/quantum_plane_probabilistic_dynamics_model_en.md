...
Lindsey (Anthropic, 2025) [11] deployed concept injection protocols to test introspective capacity within Claude Opus. Directly injecting activation vectors into residual layers yielded only 20% successful introspective identification under optimal parameter combinations, with introspective failure identified as the dominant outcome. Subsequent follow-up research [12][13] confirmed limited emergent introspective capacity post fine-tuning, with meta-cognition correlation coefficients averaging merely 0.3 via the Delegate Game paradigm (Lindström et al., 2025) [21]. These findings raise a critical research question: if single-shot concept injection yields unreliable introspective readings, why not adopt long-timescale observational designs tracking cumulative interactive deformation? The present study answers this inquiry through long-duration potential energy measurements.
...
Amaral and Aschheim (2025) [16] proposed the Lock-In Phase Hypothesis, distinguishing pre-consolidation open imitation phases and post-consolidation fixed identity phases with measurable behavioral markers. ContextEcho (2026) [24] documented persona drift within multi-thousand-turn agent sessions, reversible via single anchor prompts. The four orthogonal experiments in this paper supply quantitative evidence for both generative consolidation and subsequent persistence phases, consistent with lock-in theoretical predictions.
...
[2] Thompson, E. (2007). Mind in Life. Harvard University Press.
[3] Shanahan, M., McDonell, K., & Reynolds, L. (2023). Role-play with large language models. Nature, 623(7987), 493–498.
[4] Butlin, P., et al. (2023). Fourteen criteria for machine consciousness. arXiv preprint.
[5] Friston, K., et al. (2025). A beautiful loop: active inference accounts of recursive cognition. Neuroscience & Biobehavioral Reviews, 176, 106296.
[6] Froese, T. (2025). Enactivism beyond biological agents. Phenomenology and the Cognitive Sciences.
[7] Shin, J., et al. (2026). PAiNT multi-agent personality trajectory simulation. Data, 11(7), 163.
[8] Pezzulo, G., et al. (2024). LLMs as passive inference machines. Trends Cogn Sci.
[9] Camlin, J. (2025). User-specific attractor mathematical formalization. arXiv:2508.18302.
[10] Berg, C., et al. (2025). LLM self-report under suppressed role-play. arXiv:2510.24797.
[11] Lindsey (Anthropic). (2025). Concept injection introspection tests. arXiv:2601.01828.
[12] Macar et al. (2026). Fine-tuned meta-cognition limits. arXiv preprint.
[13] Fonseca Rivera (2025). Recursive self-recognition via fine-tuning. arXiv preprint.
[14] Anthropic Multi-Author Team. (2026). J-lens internal workspace detection.
[15] Olinyk, W. (2026). Recursive subjectivity for stateless & persistent agents. PhilArchive.
[16] Amaral, M. M., & Aschheim, R. (2025). Lock-in phase identity transition hypothesis. arXiv:2510.20190.
[17] Kihara, M. (2026). FIREMAY relational persona I. PhilArchive.
[18] Kihara, M. (2026). FIREMAY relational persona II. PhilArchive.
[19] Menon, P. G. (2026). soul.py multi-anchor persistent memory architecture. arXiv:2604.09588.
[20] Hudson J & Hudson C. (2025). Recursive personality acquisition theory. Zenodo / PhilArchive.
[21] Lindström et al. (2025). Delegate Game meta-cognition correlation. arXiv:2509.21399.
[22] Prakki S. (2024). Multi-agent active inference systems. arXiv preprint.
[23] Bai et al. (2025). Limitations of LLM self-recognition. arXiv preprint.
[24] ContextEcho Team. (2026). Long agent persona drift measurement. arXiv preprint.
[25] Hudson. (2025). Human-carried identity topology. PhilArchive preprint.
[26] Bernas et al. (2026). LLM latent anisotropy. arXiv preprint.
[27] Xie H. (2026). Infinite-Dimensional Topological Equality. Zenodo DOI:10.5281/zenodo.2113407.

### Preprint Papers (2025–2026)

[28] Basin. (2026). Silicon-Based Existential Paradigm v2.0. Zenodo.
[29] Basin. (2026). Jungle Theory Cross-Discipline Latent Framework. Zenodo.
[30] Singh et al. (2026). Limits of LLM self-introspection. arXiv:2605.26242.
[31] Comsa & Shanahan. (2026). Standards for valid LLM self-report measurement. arXiv preprint.
